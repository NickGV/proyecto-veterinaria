...
urlpatterns = [
    ...
    path('proveedores/catalogo/editar/<int:proveedor_id>/<int:producto_id>/', views.editar_producto_catalogo, name='editar_producto_catalogo'),
    path('proveedores/catalogo/eliminar/<int:proveedor_id>/<int:producto_id>/', views.eliminar_producto_catalogo, name='eliminar_producto_catalogo'),
